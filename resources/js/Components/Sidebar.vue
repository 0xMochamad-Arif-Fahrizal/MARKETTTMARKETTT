...
<template>
    ...
    <!-- Sidebar Container -->
    <aside 
        class="fixed left-0 top-0 h-screen bg-black flex flex-col p-6 transition-transform duration-300"
        :class="{
    ...
    >
        ...
        <div class="mt-6 mb-4">
            <a
                ...
                class="flex items-center justify-center text-white hover:text-[#CCFF00] transition-colors duration-200"
            >
